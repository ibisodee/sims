                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Pending Results Master Sheet</h4>
                                </div>                 
                            </div>
                        </div>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <form action="{{ route('exams.destroy',$exam->id) }}" method="POST">
                                                        ...
                                                        <a class="dropdown-item btn btn-info" href="{{ route('exams.show',$exam->id) }}">Show</a>    
                                                        <a class="dropdown-item btn btn-primary" href="{{ route('exams.edit',$exam->id) }}">Update</a>
                                                        @csrf
                                                        @method('DELETE')                                        
