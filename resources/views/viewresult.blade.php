                                                ...
                                                <div class="nav-link list-actions" id="invoice-00001" data-invoice-id="00001">
                                                    <div class="f-m-body">
                                                        ...
                                                        <div class="f-body">
                                                            ...
                                                            <a href="/user/checkresult" class="btn btn-primary btn-xs">Back to List </a>
                                                        </div> 
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <div class="content-section  animated animatedFadeInUp fadeInUp">
                                                ...
                                                <div class="row inv--head-section">
													...
													<div class="col-sm-6 align-self-center  text-sm-left order-sm-0 order-1">
                                                        <p class="inv-street-addr">Road 13 First Avenue New Road, Off Ada-George-Location Road, Port Harcourt, Rivers State <br><strong>Tel: 08032699215, 08132151506</strong></p>
                                                    </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        @if ( $Info->sub11 != Null )
                                                                            ...
                                                                            <td class="text-center">{{ $ss11=$Info->sub11_ca2}}</td>
                                                                    ...
                                                                    <tr>
                                                                        @if ( $Info->sub16 != Null )
                                                                            <td>{{ $Info->sub16}}</td>
                                                                            <td class="text-center">{{ $Info->sub16_ca1}}</td>
                                                                            <td class="text-center">{{ $Info->sub16_ca2}}</td>
                                                                            <td class="text-center">{{ $Info->note16}}</td>
                                                                            <td class="text-center">{{ $Info->project16}}</td>
                                                                            <td class="text-center">{{ $Info->sub16_exam}}</td>
                                                                            <td class="text-center">{{ $total16= $Info->sub16_ca1+$Info->sub16_ca2+$Info->project16+$Info->note16+$Info->sub16_exam}}</td>
                                                                            <td class="text-center">{{ $Info->sub16_position}}</td>
                                                                            <td class="text-center">
                                                                                @if ($total16 >= 90 && $total16 <= 100 )
                                                                                    A
                                                                                @elseif ($total16 >= 70 && $total16 <= 89 )
                                                                                    B
                                                                                @elseif ($total16 >= 40 && $total16 <= 69 )
                                                                                    C
                                                                                @elseif ($total16 >= 40 && $total16 <= 49 )
                                                                                    D
                                                                                @else
                                                                                    E
                                                                                @endif
                                                                    ...
                                                                    <tr>
                                                                        @if ( $Info->sub17 != Null )
                                                                            <td>{{ $Info->sub17}}</td>
                                                                            <td class="text-center">{{ $Info->sub17_ca1}}</td>
                                                                            <td class="text-center">{{ $Info->sub17_ca2}}</td>
                                                                            <td class="text-center">{{ $Info->note17}}</td>
                                                                            <td class="text-center">{{ $Info->project17}}</td>
                                                                            <td class="text-center">{{ $Info->sub17_exam}}</td>
                                                                            <td class="text-center">{{ $total17= $Info->sub17_ca1+$Info->sub17_ca2+$Info->project17+$Info->note17+$Info->sub17_exam}}</td>
                                                                            <td class="text-center">{{ $Info->sub17_position}}</td>
                                                                            <td class="text-center">
                                                                                @if ($total17 >= 90 && $total17 <= 100 )
                                                                                    A
                                                                                @elseif ($total17 >= 70 && $total17 <= 89 )
                                                                                    B
                                                                                @elseif ($total17 >= 40 && $total17 <= 69 )
                                                                                    C
                                                                                @elseif ($total17 >= 40 && $total17 <= 49 )
                                                                                    D
                                                                                @else
                                                                                    E
                                                                                @endif
                                                                    ...
                                                                    <tr>
                                                                        @if ( $Info->sub18 != Null )
                                                                            <td>{{ $Info->sub18}}</td>
                                                                            <td class="text-center">{{ $Info->sub18_ca1}}</td>
                                                                            <td class="text-center">{{ $Info->sub18_ca2}}</td>
                                                                            <td class="text-center">{{ $Info->note18}}</td>
                                                                            <td class="text-center">{{ $Info->project18}}</td>
                                                                            <td class="text-center">{{ $Info->sub18_exam}}</td>
                                                                            <td class="text-center">{{ $total18= $Info->sub18_ca1+$Info->sub18_ca2+$Info->project18+$Info->note18+$Info->sub18_exam}}</td>
                                                                            <td class="text-center">{{ $Info->sub18_position}}</td>
                                                                            <td class="text-center">
                                                                                @if ($total18 >= 90 && $total18 <= 100 )
                                                                                    A
                                                                                @elseif ($total18 >= 70 && $total18 <= 89 )
                                                                                    B
                                                                                @elseif ($total18 >= 40 && $total18 <= 69 )
                                                                                    C
                                                                                @elseif ($total18 >= 40 && $total18 <= 49 )
                                                                                    D
                                                                                @else
                                                                                    E
                                                                                @endif
