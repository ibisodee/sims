                                            ...
                                            <div class="content-section  animated animatedFadeInUp fadeInUp">
                                                ...
                                                <div class="row inv--detail-section">
													...
													<div class="col-sm-5 align-self-center">
                                                        ...
                                                        <p class="inv-created-date"><span class="inv-title">No. of Time Present : </span> <span class="inv-date">{{ $Info->attendance }} </span></p>
                                                        <p class="inv-due-date"><span class="inv-title">No. of Time Absent : </span> <span class="inv-date"></span>{{ $Info->absent }}</p>
